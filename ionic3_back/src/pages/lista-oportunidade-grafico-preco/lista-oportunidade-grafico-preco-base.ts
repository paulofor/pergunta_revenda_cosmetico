...
export abstract class ListaOportunidadeGraficoPrecoPageBase extends ComponenteBase{
	...
	private chave : string = '381f61a868fab07d7c2534e51c74c4017b6682a4';
	
	 
	getPageEdicao(): Page {
	
    	throw new Error("ListaOportunidadeGraficoPrecoPage sem tela de edicao.");
    	
  	}
  	getPageDetalhe(): Page {
	
    	throw new Error("ListaOportunidadeGraficoPrecoPage sem tela de detalhe.");
	...
	ionViewWillEnter() {
		...
		console.log('');
    		console.log('Tela: ListaOportunidadeGraficoPrecoPage<<LISTA_FIND_APP>> : OportunidadeDia');
    		this.carregaUsuario();
    		this.inicializacao();
