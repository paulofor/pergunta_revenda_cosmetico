...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_generica_base__ = __webpack_require__(852);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pag_seguro_assinatura_dado_identificacao_pag_seguro_assinatura_dado_identificacao__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
...
var ListaOportunidadeGenericaPage = /** @class */ (function (_super) {
    ...
    function ListaOportunidadeGenericaPage(navCtrl, srv, storage, fcmSrv, usuarioSrv) {
        ...
        // Status Cliente
        _this.periodoGratuito = true;
        _this.assinante = false;
        return _this;
    }
    ...
    ListaOportunidadeGenericaPage.prototype.inicioFluxo = function () {
    ...
    ListaOportunidadeGenericaPage.prototype.obtemDiasGratis = function () {
        var _this = this;
        ...
        this.storage.get("chave").then(function (chave) {
            ...
            _this.usuarioSrv.PeriodoGratuito(chave)
                ...
                if (result.dias <= 0) {
                    _this.diasGratis = "encerrado";
                }
                else {
                    _this.diasGratis = result.dias + ' dias';
                }
                _this.periodoGratuito = _this.verificaPeriodoGratuito(result);
                _this.assinante = _this.verificaAssinante(result);
            }, function (erro) {
    ...
    ListaOportunidadeGenericaPage.prototype.verificaPeriodoGratuito = function (result) {
        if (result.dias > 0) {
            return true;
        }
        else {
    ...
    ListaOportunidadeGenericaPage.prototype.verificaAssinante = function (resultado) {
        var saida = false;
    ...
    ListaOportunidadeGenericaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lista-oportunidade-generica',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-generica/lista-oportunidade-generica.html"*/'<ion-header>\n  <ion-navbar hideBackButton color="titulo">\n    <ion-title>Oportunidades do Dia</ion-title>\n    <ion-title *ngIf="!assinante" (click)="registraFake()">Período gratuito: {{diasGratis}}</ion-title>\n    <button *ngIf="!assinante" ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="quadroBase">\n\n  <ng-container *ngIf="(!periodoGratuito && !assinante)">\n    <ion-content padding>\n      <button ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n    </ion-content>\n  </ng-container>\n\n  <ng-container *ngIf="(!listaItem && (periodoGratuito || assinante))">\n    <ion-content padding class="spinnerCenter">\n      <ion-spinner name="crescent"></ion-spinner>\n    </ion-content>\n  </ng-container>\n\n\n  <ng-container *ngIf="(listaItem && (periodoGratuito || assinante))">\n    <ion-card *ngIf="listaItem.length==0">\n      <ion-card-header>\n        Nenhum item encontrado\n      </ion-card-header>\n    </ion-card>\n    <ion-list *ngIf="listaItem.length>0">\n      <ion-card *ngFor="let item of listaItem">\n        <ion-card-content text-wrap>\n          <h2 class="texto-produto" style="word-wrap: normal">{{item.nomeProduto}}</h2>\n          <img src="{{item.imagemProduto}}">\n          <h3 class="texto-preco">Preço até {{item.dataUltimaPrecoAnterior | date : \'dd/MM/yyyy\'}}: R$\n            {{item.precoVendaAnterior | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco">Preço atual: R$ {{item.precoVendaAtual | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco" *ngIf="top50(item)">Top 50 - Vendas</h3>\n          <h3 class="texto-loja">Loja: {{item.nomeLojaVirtual}}</h3>\n          <a button href="{{item.urlProduto}}" rounded ion-button>Ir para loja</a>\n        </ion-card-content>\n      </ion-card>\n    </ion-list>\n  </ng-container>\n\n</ion-content>'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-generica/lista-oportunidade-generica.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__shared_sdk__["f" /* OportunidadeDiaApi */],
            __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__["a" /* AcessaFcmService */], __WEBPACK_IMPORTED_MODULE_7__shared_sdk_services_custom_UsuarioProduto__["a" /* UsuarioProdutoApi */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SDKModels__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_base_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_operators___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_rxjs_operators__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__sockets_socket_connections__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_const__ = __webpack_require__(17);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var DispositivoUsuarioApi = /** @class */ (function (_super) {
    ...
    DispositivoUsuarioApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_9__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/DispositivoUsuarios";
        var _routeParams = {};
        var _postBody = {
            data: data
    ...
    DispositivoUsuarioApi.prototype.criaItem = function (data, customHeaders) {
        var _this = this;
        return this.request('POST', [
            __WEBPACK_IMPORTED_MODULE_9__app_const__["f" /* PathValidador */],
            __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion(),
            this.model.getModelDefinition().path
        ].join('/'), undefined, undefined, { data: data }, null, customHeaders)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_7_rxjs_operators__["map"])(function (data) { return _this.model.factory(data); }));
    ...
    DispositivoUsuarioApi.prototype.FindByUuid = function (uuid, customHeaders) {
        if (uuid === void 0) { uuid = {}; }
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_9__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
    ...
    DispositivoUsuarioApi = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */])),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_8__sockets_socket_connections__["a" /* SocketConnection */])),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_2__SDKModels__["a" /* SDKModels */])),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return VERSAO_APP_ID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return PathValidador; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return PathPagSeguro; });
...
var VERSAO_APP_ID = 11;
var PathValidador = 'https://www.digicom.inf.br:21040';
//export var PathValidador : string = 'https://www.digicom.inf.br:21101';
var PathPagSeguro = 'https://www.digicom.inf.br:21101';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pag_seguro_assinatura_dado_cartao_pag_seguro_assinatura_dado_cartao__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_const__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagSeguroAssinaturaDadoClientePage = /** @class */ (function () {
    function PagSeguroAssinaturaDadoClientePage(navCtrl, navParams, fcmSrv) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.fcmSrv = fcmSrv;
        this.chavePagina = '7bd51c0887db867d7e6e91323fdecd1f88a8188e';
        this.address = {
            "street": "",
            "number": "",
            "complement": "",
    ...
    PagSeguroAssinaturaDadoClientePage.prototype.ionViewDidLoad = function () {
        ...
        this.inicializacao();
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_5__app_const__["g" /* VERSAO_APP_ID */]);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_services_integracao_PagSeguro__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pag_seguro_assinatura_confirmacao_pag_seguro_assinatura_confirmacao__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_const__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PagSeguroAssinaturaDadoCartaoPage = /** @class */ (function () {
    function PagSeguroAssinaturaDadoCartaoPage(navCtrl, navParams, pagSrv, fcmSrv) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.pagSrv = pagSrv;
        this.fcmSrv = fcmSrv;
        this.chavePagina = '27dbb494777224b5ccf3177f5284171b235812aa';
        this.codigoFinal = '';
        this.cartao = {
            "nomeCartao": "",
            "bandeira": "",
    ...
    PagSeguroAssinaturaDadoCartaoPage.prototype.enviar = function () {
        ...
        if (this.validacao()) {
            this.obtemTokenCartao()
                ...
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].anoExpira = _this.cartao.anoExpira;
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].bandeira = _this.cartao.bandeira;
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].mesExpira = _this.cartao.mesExpira;
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].nomeCartao = _this.cartao.nomeCartao;
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].numero = _this.cartao.numero;
                __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */].verificador = _this.cartao.verificador;
                _this.exibeLoading = false;
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__pag_seguro_assinatura_confirmacao_pag_seguro_assinatura_confirmacao__["a" /* PagSeguroAssinaturaConfirmacaoPage */]);
            })
                .catch(function (result) {
                console.log('Catch', result);
                _this.erroServidor = _this.trataErro(result.errors);
                _this.exibeLoading = false;
            });
        }
        else {
    ...
    PagSeguroAssinaturaDadoCartaoPage.prototype.trataErro = function (result) {
        console.log('Result-Erro:', result);
        if (result[10000])
            return 'Bandeira do cartão incorreta';
        if (result[10001])
    ...
    PagSeguroAssinaturaDadoCartaoPage.prototype.ionViewDidLoad = function () {
        ...
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_6__app_const__["g" /* VERSAO_APP_ID */]);
    ...
    PagSeguroAssinaturaDadoCartaoPage.prototype.obtemHashCliente = function () {
        ...
        PagSeguroDirectPayment.onSenderHashReady(function (response) {
            ...
            __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["a" /* Assinatura */].sender.hash = response.senderHash;
        });
    };
    PagSeguroAssinaturaDadoCartaoPage.prototype.obtemTokenCartao = function () {
        ...
        return new Promise(function (resolve, reject) {
            PagSeguroDirectPayment.createCardToken({
                cardNumber: _this.cartao.numero,
                brand: _this.cartao.bandeira,
                cvv: _this.cartao.verificador,
                expirationMonth: _this.cartao.mesExpira,
                expirationYear: '20' + _this.cartao.anoExpira,
                success: function (response) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["a" /* Assinatura */].paymentMethod.creditCard.holder.name = _this.cartao.nomeCartao;
    ...
    */
    ...
    PagSeguroAssinaturaDadoCartaoPage.prototype.voltar = function () {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PagSeguroAssinaturaConfirmacaoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_services_integracao_PagSeguro__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pag_seguro_assinatura_sucesso_pag_seguro_assinatura_sucesso__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_const__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Ionic pages and navigation.
 */
var PagSeguroAssinaturaConfirmacaoPage = /** @class */ (function () {
    function PagSeguroAssinaturaConfirmacaoPage(navCtrl, navParams, pagSrv, storage, usuarioSrv, fcmSrv) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.pagSrv = pagSrv;
        ...
        this.fcmSrv = fcmSrv;
        this.chavePagina = '557b4687345609d78d1f48c605d45ddd666a3a3c';
        this.erroServidor = '';
        this.exibeLoading = false;
    }
    PagSeguroAssinaturaConfirmacaoPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        console.log('ionViewDidLoad PagSeguroAssinaturaConfirmacaoPage');
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_8__app_const__["g" /* VERSAO_APP_ID */]);
        this.assinatura = __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["a" /* Assinatura */];
        this.cartao = __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["b" /* Cartao */];
        this.storage.get("chave")
            .then(function (chave) {
            _this.chave = chave;
        });
    };
    PagSeguroAssinaturaConfirmacaoPage.prototype.getBandeira = function () {
        var saida = '';
        if (this.cartao.bandeira == 'visa')
            saida = 'Visa';
        if (this.cartao.bandeira == 'mastercard')
            saida = 'MasterCard';
        if (this.cartao.bandeira == 'diners')
            saida = 'Diners';
        return saida;
    };
    PagSeguroAssinaturaConfirmacaoPage.prototype.enviar = function () {
        var _this = this;
        this.exibeLoading = true;
        ...
        this.pagSrv.AderePlanoTreino(__WEBPACK_IMPORTED_MODULE_2__shared_assinatura__["a" /* Assinatura */])
            ...
            if (result.code) {
                _this.usuarioSrv.RegistraAssinatura(_this.chave, result.code)
                    .subscribe(function (result) {
                    _this.exibeLoading = false;
                    _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__pag_seguro_assinatura_sucesso_pag_seguro_assinatura_sucesso__["a" /* PagSeguroAssinaturaSucessoPage */]);
                });
            }
        });
    };
    PagSeguroAssinaturaConfirmacaoPage.prototype.voltar = function () {
        this.navCtrl.pop();
    };
    PagSeguroAssinaturaConfirmacaoPage.prototype.trataErro = function (erro) {
        if (erro[53048])
            return 'Erro na data de nascimento';
        if (erro[10003] || erro[10026] || erro[10050])
            return 'Erro no email';
        if (erro[10025] || erro[10049])
            return 'Erro no nome';
        if (erro[11013])
            return 'Erro no DDD de telefone';
        if (erro[11014] || erro[19014])
            return 'Erro no número de telefone';
        if (erro[17065] | erro[50103] || erro[61008] || erro[61009] || erro[61010] | erro[61011])
            return 'Erro no cpf';
        if (erro[17070])
            return 'Erro no endereço';
        if (erro[19001])
            return 'Erro no CEP do endereço';
        if (erro[19002])
            return 'Erro no nome de rua do endereço';
        if (erro[19003] || erro[50105])
            return 'Erro no número de rua do endereço';
        if (erro[19004])
            return 'Erro no complemento de endereço';
        if (erro[19005] || erro[50106])
            return 'Erro no bairro do endereço';
        if (erro[19006] || erro[50108])
            return 'Erro na cidade do endereço';
        if (erro[19007] || erro[57038])
            return 'Erro no estado do endereço';
        if (erro[19008] || erro[50107])
            return 'Erro no pais do endereço';
        if (erro[53042])
            return 'Erro no nome do titular do cartão de crédito';
        return 'Erro nos dados';
    };
    PagSeguroAssinaturaConfirmacaoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pag-seguro-assinatura-confirmacao',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-confirmacao/pag-seguro-assinatura-confirmacao.html"*/'<!--\n  Generated template for the PagSeguroAssinaturaConfirmacaoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title >Confirmação (4 de 4)</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content *ngIf="exibeLoading" class="quadroCarregando spinnerCenter" padding>\n  <ion-spinner name="crescent"></ion-spinner>\n</ion-content>\n\n<ion-content *ngIf="assinatura" padding>\n  <ion-label>Assinatura: R$ 4,99 / mês</ion-label>\n  <ion-label></ion-label>\n  <ion-label class="erroMsg">{{erroServidor}}</ion-label>\n  <ion-label></ion-label>\n  <ion-label>Nome: {{assinatura.sender.name}}</ion-label>\n  <ion-label>Email: {{assinatura.sender.email}}</ion-label>\n  <ion-label>Tel: {{assinatura.sender.phone.areaCode}}-{{assinatura.sender.phone.number}}</ion-label>\n  <ion-label>Cpf: {{assinatura.sender.documents[0].value}}</ion-label>\n  <ion-label>Data Nascimento: {{assinatura.paymentMethod.creditCard.holder.birthDate}}</ion-label>\n  <ion-label></ion-label>\n  <ion-label>Endereço:</ion-label>\n  <ion-label>{{assinatura.sender.address.street}}, {{assinatura.sender.address.number}} {{assinatura.sender.address.complement}}</ion-label>\n  <ion-label>{{assinatura.sender.address.district}} - {{assinatura.sender.address.city}} ({{assinatura.sender.address.state}})</ion-label>\n  <ion-label>{{assinatura.sender.address.postalCode}}</ion-label>\n  <ion-label></ion-label>\n  <ion-label>Cartão</ion-label>\n  <ion-label>Nome: {{cartao.nomeCartao}}</ion-label>\n  <ion-label>Número: {{cartao.numero}}</ion-label>\n  <ion-label>Validade: {{cartao.mesExpira}}/{{cartao.anoExpira}}</ion-label>\n  <ion-label>Cvv: {{cartao.verificador}}</ion-label>\n  <ion-label>Bandeira: {{getBandeira()}}</ion-label>\n\n  <button ion-button (click)="voltar()">Voltar</button>\n  <button ion-button (click)="enviar()">Confirmar</button>\n</ion-content>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-confirmacao/pag-seguro-assinatura-confirmacao.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__shared_sdk_services_integracao_PagSeguro__["a" /* PagSeguroApi */], __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_4__shared_sdk_services_custom_UsuarioProduto__["a" /* UsuarioProdutoApi */],
            __WEBPACK_IMPORTED_MODULE_7__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
    ], PagSeguroAssinaturaConfirmacaoPage);
    return PagSeguroAssinaturaConfirmacaoPage;
}());

//# sourceMappingURL=pag-seguro-assinatura-confirmacao.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PagSeguroAssinaturaSucessoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_preco_assinatura_lista_oportunidade_preco_assinatura__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__servico_acessa_fcm_service__ = __webpack_require__(31);
 ...
 * Ionic pages and navigation.
 */
var PagSeguroAssinaturaSucessoPage = /** @class */ (function () {
    function PagSeguroAssinaturaSucessoPage(navCtrl, navParams, fcmSrv) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.fcmSrv = fcmSrv;
        this.chavePagina = "4802fdf28ddc6301b2748af6a64ab5a136085f12";
    }
    PagSeguroAssinaturaSucessoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PagSeguroAssinaturaSucessoPage');
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_4__app_const__["g" /* VERSAO_APP_ID */]);
    };
    PagSeguroAssinaturaSucessoPage.prototype.iniciar = function () {
        var _this = this;
        //this.navCtrl.push(ListaOportunidadePrecoAssinaturaPage);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_preco_assinatura_lista_oportunidade_preco_assinatura__["a" /* ListaOportunidadePrecoAssinaturaPage */]).then(function () {
            console.log('Tamanho: ', _this.navCtrl.length());
            console.log('this.navCtrl:', _this.navCtrl);
            var index = 1;
            _this.navCtrl.remove(0, _this.navCtrl.length() - 1);
        });
    };
    PagSeguroAssinaturaSucessoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pag-seguro-assinatura-sucesso',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-sucesso/pag-seguro-assinatura-sucesso.html"*/'<!--\n  Generated template for the PagSeguroAssinaturaSucessoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title >Assinatura Concluida</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n    <p padding>Sua solicitação foi recebida, em breve você receberá email de confirmação PagSeguro</p>\n    <ion-label></ion-label>\n    <button ion-button padding (click)="iniciar()">Iniciar</button>\n</ion-content>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-sucesso/pag-seguro-assinatura-sucesso.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
    ], PagSeguroAssinaturaSucessoPage);
    return PagSeguroAssinaturaSucessoPage;
}());

//# sourceMappingURL=pag-seguro-assinatura-sucesso.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_index__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pag_seguro_assinatura_dado_identificacao_pag_seguro_assinatura_dado_identificacao__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lista_oportunidade_assinatura_lista_oportunidade_assinatura_base__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_const__ = __webpack_require__(17);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
...
var ListaOportunidadePrecoAssinaturaPage = /** @class */ (function (_super) {
    ...
    ListaOportunidadePrecoAssinaturaPage.prototype.verificaPeriodoGratuito = function (result) {
        if (result.dias > 0) {
            return true;
        }
        else {
    ...
    ListaOportunidadePrecoAssinaturaPage.prototype.verificaAssinante = function (resultado) {
        var saida = false;
        if (resultado.status == 'ACTIVE')
            saida = true;
        return saida;
    };
    ListaOportunidadePrecoAssinaturaPage.prototype.registraFake = function () {
        console.log('Chamou registra fake');
        var dispositivoUsuario = new __WEBPACK_IMPORTED_MODULE_3__shared_sdk_index__["c" /* DispositivoUsuario */]();
        dispositivoUsuario.tokenFcm = 'ABCDEFG';
        dispositivoUsuario.versaoAppId = __WEBPACK_IMPORTED_MODULE_8__app_const__["g" /* VERSAO_APP_ID */];
        ...
        this.fcmSrv.criaComUsuario(dispositivoUsuario, __WEBPACK_IMPORTED_MODULE_8__app_const__["g" /* VERSAO_APP_ID */]);
    };
    ListaOportunidadePrecoAssinaturaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lista-oportunidade-preco-assinatura',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-preco-assinatura/lista-oportunidade-preco-assinatura.html"*/'<ion-header>\n  <ion-navbar hideBackButton color="titulo">\n    <ion-title>Oportunidades do Dia</ion-title>\n    <ion-title *ngIf="!assinante" (click)="registraFake()">Período gratuito: {{diasGratis}}</ion-title>\n    <button *ngIf="!assinante" ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="quadroBase">\n\n\n  <ng-container *ngIf="(!periodoGratuito && !assinante)">\n    <ion-content padding>\n        <button ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n    </ion-content>\n  </ng-container>\n\n  <ng-container *ngIf="(!listaItem && (periodoGratuito || assinante))">\n    <ion-content padding class="spinnerCenter">\n      <ion-spinner name="crescent"></ion-spinner>\n    </ion-content>\n  </ng-container>\n\n  <ng-container *ngIf="(listaItem && (periodoGratuito || assinante))">\n    <ion-card *ngIf="listaItem.length==0">\n      <ion-card-header>\n        Nenhum item encontrado\n      </ion-card-header>\n    </ion-card>\n    <ion-list *ngIf="listaItem.length>0">\n      <ion-card *ngFor="let item of listaItem">\n        <ion-card-content text-wrap>\n          <h2 class="texto-produto" style="word-wrap: normal">{{item.nomeProduto}}</h2>\n          <img src="{{item.imagemProduto}}">\n          <h3 class="texto-preco">Sugestão de venda: R$ {{item.precoSugestao | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco">Preço na loja: R$ {{item.precoVendaAtual | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco" *ngIf="top50(item)">Top 50 - Vendas</h3>\n          <h3 class="texto-loja">Loja: {{item.nomeLojaVirtual}}</h3>\n          <a button href="{{item.urlProduto}}" rounded ion-button>Ir para loja</a>\n        </ion-card-content>\n      </ion-card>\n    </ion-list>\n  </ng-container>\n\n</ion-content>'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-preco-assinatura/lista-oportunidade-preco-assinatura.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__shared_sdk_index__["f" /* OportunidadeDiaApi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_sdk_index__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__login_base__ = __webpack_require__(855);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services_integracao_PagSeguro__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__lista_oportunidade_generica_lista_oportunidade_generica__ = __webpack_require__(107);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var LoginPage = /** @class */ (function (_super) {
    ...
    function LoginPage(navCtrl, navParams, formBuilder, srv, srvACao, storage, pagSeguro, fcmSrv) {
        var _this = _super.call(this, navCtrl, navParams, formBuilder, srv, srvACao, storage, pagSeguro, fcmSrv) || this;
        _this.navCtrl = navCtrl;
    ...
    LoginPage.prototype.getPaginaInicial = function () {
        var proxima = __WEBPACK_IMPORTED_MODULE_9__lista_oportunidade_generica_lista_oportunidade_generica__["a" /* ListaOportunidadeGenericaPage */];
        console.log('Proxima: ', proxima);
        return proxima;
    };
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-login',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/login/login.html"*/'<ion-content>\n\n  <div id="logo">\n    <img width="100%" heigth="100%" src="assets/imgs/logoTela.png" (click)="criaFoto()"/>\n  </div>\n\n\n  <form padding [formGroup]="loginForm" (ngSubmit)="onSubmit()" novalidate>\n    <ion-list>\n\n\n      <ion-item>\n        <ion-label floating>Email</ion-label>\n        <ion-input type="email" formControlName="login" required></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label floating>Senha</ion-label>\n        <ion-input type="password" formControlName="senha" required></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <!-- bug de inputs -->\n      </ion-item>\n\n      <ion-item *ngIf="erroMsg">\n        <p class="erroMsg">{{erroMsg}}</p>\n      </ion-item>\n    </ion-list>\n    <div width="100%" style="align-content: center;">\n      <button ion-button round class="botaoPrincipal" type="submit">Entrar</button>\n    </div>\n\n  </form>\n\n\n  <button class="criaEsquece" ion-button (click)="criarConta()" color="primary" outline >Primeiro Acesso</button>\n\n</ion-content>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_8__shared_sdk_services_custom_UsuarioProduto__["a" /* UsuarioProdutoApi */],
            __WEBPACK_IMPORTED_MODULE_2__shared_sdk_index__["b" /* AcaoApi */], __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services_integracao_PagSeguro__["a" /* PagSeguroApi */], __WEBPACK_IMPORTED_MODULE_7__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
    ], LoginPage);
    return LoginPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__signup_base__ = __webpack_require__(856);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__lista_oportunidade_generica_lista_oportunidade_generica__ = __webpack_require__(107);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SignupPage = /** @class */ (function (_super) {
    ...
    function SignupPage(navCtrl, formBuilder, storage, srv, fcmSrv) {
        var _this = _super.call(this, navCtrl, formBuilder, storage, srv, fcmSrv) || this;
        _this.navCtrl = navCtrl;
        _this.formBuilder = formBuilder;
        _this.storage = storage;
        _this.srv = srv;
    ...
    SignupPage.prototype.getPaginaInicial = function () {
        var proxima = __WEBPACK_IMPORTED_MODULE_7__lista_oportunidade_generica_lista_oportunidade_generica__["a" /* ListaOportunidadeGenericaPage */];
        return proxima;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_BaseModels__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var map = {
	...
	"../pages/pag-seguro-assinatura-confirmacao/pag-seguro-assinatura-confirmacao.module": [
		894,
		12
	],
	...
	"../pages/pag-seguro-assinatura-sucesso/pag-seguro-assinatura-sucesso.module": [
		898,
		8
	],
...
var LoopBackConfig = /** @class */ (function () {
    ...
    LoopBackConfig.path = 'https://www.digicom.inf.br:21189';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_throw__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_Container__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_User__ = __webpack_require__(564);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_Visitante__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_DispositivoUsuario__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_VisitaApp__ = __webpack_require__(565);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_OportunidadeDia__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_Usuario__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_Acao__ = __webpack_require__(247);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__socket_driver__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_sdk_services_custom_Visitante__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk_services_custom_DispositivoUsuario__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_sdk_models_DispositivoUsuario__ = __webpack_require__(140);
...
var AcessaFcmService = /** @class */ (function () {
    ...
    // Chamada externa
    AcessaFcmService.prototype.registraVisitaPagina = function (chavePagina, versaoAppId) {
        var _this = this;
        this.storage.get("chave").then(function (chaveUsuario) {
            if (chaveUsuario) {
                _this.visitaAppSrv.RegistraVisitaTelaApp(chaveUsuario, chavePagina, versaoAppId)
    ...
    AcessaFcmService.prototype.executaValidacaoRemote = function (versaoAppId) {
        ...
        this.dispositivoUsuarioSrv.FindByUuid(this.device.uuid)
            .subscribe(function (dispositivo) {
            if (dispositivo) {
                console.log('Encontrou usuario por uuid');
                _this.ligaReceptorNotificacao();
                _this.registraMobile(dispositivo.usuarioProduto.chave, versaoAppId);
                _this.registraVisitaApp(dispositivo.usuarioProduto.chave, versaoAppId);
            }
            else {
    ...
    AcessaFcmService.prototype.criaComUsuario = function (dispositivo, versaoApp) {
        var _this = this;
        this.dispositivoUsuarioSrv.CriaComUsuario(dispositivo)
            .subscribe(function (resultado) {
            _this.registraMobile(resultado, versaoApp);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lb_config__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__custom_SDKModels__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs__ = __webpack_require__(73);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return SDKBrowserModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_custom_logger_service__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_custom_SDKModels__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__storage_cookie_browser__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__storage_storage_browser__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__sockets_socket_connections__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_core_real_time__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_custom_User__ = __webpack_require__(851);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_custom_Container__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_custom_OportunidadeDia__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_custom_Usuario__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_custom_Acao__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__models_index__ = __webpack_require__(341);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_17__models_index__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __WEBPACK_IMPORTED_MODULE_17__models_index__["d"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_index__ = __webpack_require__(339);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_18__services_index__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_18__services_index__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_18__services_index__["d"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__lb_config__ = __webpack_require__(24);
/* unused harmony namespace reexport */
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_4__storage_storage_swaps__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_index__ = __webpack_require__(838);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io_service__ = __webpack_require__(839);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__auth_service__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_FireLoop__ = __webpack_require__(840);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__OportunidadeDia__ = __webpack_require__(245);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Usuario__ = __webpack_require__(246);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Acao__ = __webpack_require__(247);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Container__ = __webpack_require__(243);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BaseModels__ = __webpack_require__(242);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__FireLoopRef__ = __webpack_require__(841);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_5__FireLoopRef__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__UsuarioProduto__ = __webpack_require__(842);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_6__UsuarioProduto__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DispositivoUsuario__ = __webpack_require__(140);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_7__DispositivoUsuario__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__NotificacaoApp__ = __webpack_require__(843);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dados_oportunidadeDia__ = __webpack_require__(60);
...
var OportunidadeDiaApi = /** @class */ (function (_super) {
    ...
    OportunidadeDiaApi.prototype.getListaOportunidadePrecoPageLoad = function (filter) {
        if (filter === void 0) { filter = {}; }
        return Object(__WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__["of"])(__WEBPACK_IMPORTED_MODULE_8__dados_oportunidadeDia__["f" /* OPORTUNIDADEDIA_LISTAOPORTUNIDADEPRECOPAGE */]);
    };
    ...
    OportunidadeDiaApi.prototype.getListaOportunidadePrecoAssinaturaPageLoad = function (filter) {
        if (filter === void 0) { filter = {}; }
        return Object(__WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__["of"])(__WEBPACK_IMPORTED_MODULE_8__dados_oportunidadeDia__["e" /* OPORTUNIDADEDIA_LISTAOPORTUNIDADEPRECOASSINATURAPAGE */]);
    };
    ...
    */
    OportunidadeDiaApi.prototype.ListaApp = function (customHeaders) {
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_error_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sockets_socket_connections__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dados_usuario__ = __webpack_require__(845);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
...
var UsuarioApi = /** @class */ (function (_super) {
    ...
    */
    UsuarioApi.prototype.ListaApp = function (customHeaders) {
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_error_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__sockets_socket_connections__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dados_acao__ = __webpack_require__(846);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_rxjs_observable_of__);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
...
var AcaoApi = /** @class */ (function (_super) {
    ...
    */
    AcaoApi.prototype.ListaApp = function (customHeaders) {
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getPath() + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
...
var VisitaAppApi = /** @class */ (function (_super) {
    ...
    VisitaAppApi.prototype.getTelaApp = function (id, refresh, customHeaders) {
        ...
        var _method = "GET";
        var _url = __WEBPACK_IMPORTED_MODULE_8__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
     ...
     * </em>
     */
    VisitaAppApi.prototype.RegistraVisitaTelaApp = function (chaveUsuario, chavePagina, idVersaoApp, customHeaders) {
        if (idVersaoApp === void 0) { idVersaoApp = {}; }
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_8__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
        ...
        if (typeof idVersaoApp !== 'undefined' && idVersaoApp !== null)
            _urlParams.idVersaoApp = idVersaoApp;
        var result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
        return result;
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_const__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__componente_base__ = __webpack_require__(62);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ListaOportunidadeAssinaturaPageBase = /** @class */ (function (_super) {
    ...
    ListaOportunidadeAssinaturaPageBase.prototype.ionViewWillEnter = function () {
        this.fcmSrv.registraVisitaPagina(this.chave, __WEBPACK_IMPORTED_MODULE_0__app_const__["g" /* VERSAO_APP_ID */]);
        console.log('');
    ...
    ListaOportunidadeAssinaturaPageBase.prototype.carregaUsuario = function () {
        var _this = this;
...
var ComandosZeroPage = /** @class */ (function () {
    ...
    ComandosZeroPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-comandos-zero',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/comandos-zero/comandos-zero.html"*/'<!--\n  Generated template for the ComandosZeroPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>ComandosZero</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/comandos-zero/comandos-zero.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], ComandosZeroPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_assinatura_base__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pag_seguro_assinatura_dado_identificacao_pag_seguro_assinatura_dado_identificacao__ = __webpack_require__(82);
...
var ListaOportunidadeAssinaturaPage = /** @class */ (function (_super) {
    ...
    ListaOportunidadeAssinaturaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lista-oportunidade-assinatura',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-assinatura/lista-oportunidade-assinatura.html"*/'<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title>Oportunidades do Dia</ion-title>\n    <button ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="quadroBase">\n\n  <ng-container *ngIf="listaItem">\n\n    <ion-card *ngIf="listaItem.length==0">\n      <ion-card-header>\n        Nenhum item encontrado\n      </ion-card-header>\n\n    </ion-card>\n\n    <ion-list *ngIf="listaItem.length>0">\n\n      <ion-card *ngFor="let item of listaItem">\n        <ion-card-content text-wrap>\n          <h2 class="texto-produto" style="word-wrap: normal">{{item.nomeProduto}}</h2>\n          <img src="{{item.imagemProduto}}">\n          <h3 class="texto-preco">Sugestão de venda: R$ {{item.precoSugestao | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco">Preço na loja: R$ {{item.precoVendaAtual | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco" *ngIf="top50(item)">Top 50 - Vendas</h3>\n          <h3 class="texto-loja">Loja: {{item.nomeLojaVirtual}}</h3>\n          <a button href="{{item.urlProduto}}" rounded ion-button>Ir para loja</a>\n        </ion-card-content>\n      </ion-card>\n\n    </ion-list>\n\n  </ng-container>\n\n\n\n</ion-content>'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-assinatura/lista-oportunidade-assinatura.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__shared_sdk__["f" /* OportunidadeDiaApi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_preco_base__ = __webpack_require__(853);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
var __extends = (this && this.__extends) || (function () {
...
var ListaOportunidadePrecoPage = /** @class */ (function (_super) {
    ...
    ListaOportunidadePrecoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lista-oportunidade-preco',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-preco/lista-oportunidade-preco.html"*/'\n<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title>Oportunidades do Dia</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="quadroBase">\n\n  <ng-container *ngIf="listaItem">\n\n    <ion-card *ngIf="listaItem.length==0">\n      <ion-card-header>\n        Nenhum item encontrado\n      </ion-card-header>\n\n    </ion-card>\n\n    <ion-list *ngIf="listaItem.length>0">\n\n      <ion-card *ngFor="let item of listaItem">\n        <ion-card-content text-wrap>\n          <h2 class="texto-produto" style="word-wrap: normal">{{item.nomeProduto}}</h2>\n          <img src="{{item.imagemProduto}}">\n          <h3 class="texto-preco">Sugestão de venda: R$ {{item.precoSugestao | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco">Preço na loja: R$ {{item.precoVendaAtual | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco" *ngIf="top50(item)">Top 50 - Vendas</h3>\n          <h3 class="texto-loja">Loja: {{item.nomeLojaVirtual}}</h3>\n          <a button href="{{item.urlProduto}}" rounded ion-button>Ir para loja</a>\n        </ion-card-content>\n      </ion-card>\n\n    </ion-list>\n\n  </ng-container>\n\n\n\n</ion-content>'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade-preco/lista-oportunidade-preco.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__shared_sdk__["f" /* OportunidadeDiaApi */],
            __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lista_oportunidade_base__ = __webpack_require__(854);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_sdk__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_cookie_service__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_sdk_services_custom_Visitante__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_sdk_models_Visitante__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_fcm__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_sdk_services_custom_DispositivoUsuario__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__servico_acessa_fcm_service__ = __webpack_require__(31);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ListaOportunidadePage = /** @class */ (function (_super) {
    ...
    ListaOportunidadePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lista-oportunidade',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade/lista-oportunidade.html"*/'<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title>Oportunidades do Dia</ion-title>\n    <button ion-button outline color="light" (click)="inicioFluxo()">Assinar (4,99 ao mês)</button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="quadroBase">\n\n  <ng-container *ngIf="listaItem">\n\n    <ion-card *ngIf="listaItem.length==0">\n      <ion-card-header>\n        Nenhum item encontrado\n      </ion-card-header>\n\n    </ion-card>\n\n    <ion-list *ngIf="listaItem.length>0">\n\n      <ion-card *ngFor="let item of listaItem">\n        <ion-card-content text-wrap>\n          <h2 class="texto-produto" style="word-wrap: normal">{{item.nomeProduto}}</h2>\n          <img src="{{item.imagemProduto}}">\n          <h3 class="texto-preco">Sugestão de venda: R$ {{item.precoSugestao | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco">Preço na loja: R$ {{item.precoVendaAtual | number: \'1.2-2\' }}</h3>\n          <h3 class="texto-preco" *ngIf="top50(item)">Top 50 - Vendas</h3>\n          <h3 class="texto-loja">Loja: {{item.nomeLojaVirtual}}</h3>\n          <a button href="{{item.urlProduto}}" rounded ion-button>Ir para loja</a>\n        </ion-card-content>\n      </ion-card>\n\n    </ion-list>\n\n  </ng-container>\n\n\n\n</ion-content>'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/lista-oportunidade/lista-oportunidade.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__shared_sdk__["f" /* OportunidadeDiaApi */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_sdk_sockets_socket_driver__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_sdk__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_component__ = __webpack_require__(874);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_home_home__ = __webpack_require__(875);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_screenshot__ = __webpack_require__(876);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_device__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ng2_charts__ = __webpack_require__(877);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_signup_signup__ = __webpack_require__(184);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_login_login__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_comandos_zero_comandos_zero__ = __webpack_require__(534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_storage__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_brmasker_ionic_3__ = __webpack_require__(882);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__shared_sdk_services_integracao_PagSeguro__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__shared_sdk_services_custom_Visitante__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_ngx_cookie_service__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_fcm__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__shared_sdk_services_custom_DispositivoUsuario__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__shared_sdk_services_custom_VisitaApp__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__shared_sdk_services_custom_NotificacaoApp__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__shared_sdk_services_custom_UsuarioProduto__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_pag_seguro_assinatura_dado_identificacao_pag_seguro_assinatura_dado_identificacao__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_pag_seguro_assinatura_dado_cliente_pag_seguro_assinatura_dado_cliente__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_pag_seguro_assinatura_dado_cartao_pag_seguro_assinatura_dado_cartao__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_pag_seguro_assinatura_confirmacao_pag_seguro_assinatura_confirmacao__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_pag_seguro_assinatura_sucesso_pag_seguro_assinatura_sucesso__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_lista_oportunidade_lista_oportunidade__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_lista_oportunidade_preco_lista_oportunidade_preco__ = __webpack_require__(536);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_lista_oportunidade_assinatura_lista_oportunidade_assinatura__ = __webpack_require__(535);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_lista_oportunidade_generica_lista_oportunidade_generica__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_lista_oportunidade_preco_assinatura_lista_oportunidade_preco_assinatura__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__ionic_native_status_bar__ = __webpack_require__(395);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__ionic_native_splash_screen__ = __webpack_require__(396);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__angular_common__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__angular_common_locales_pt__ = __webpack_require__(885);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(__WEBPACK_IMPORTED_MODULE_37__angular_common__["k" /* registerLocaleData */])(__WEBPACK_IMPORTED_MODULE_38__angular_common_locales_pt__["a" /* default */], 'pt-BR');
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_25__pages_pag_seguro_assinatura_dado_identificacao_pag_seguro_assinatura_dado_identificacao__["a" /* PagSeguroAssinaturaDadoIdentificacaoPage */],
                __WEBPACK_IMPORTED_MODULE_26__pages_pag_seguro_assinatura_dado_cliente_pag_seguro_assinatura_dado_cliente__["a" /* PagSeguroAssinaturaDadoClientePage */],
                __WEBPACK_IMPORTED_MODULE_27__pages_pag_seguro_assinatura_dado_cartao_pag_seguro_assinatura_dado_cartao__["a" /* PagSeguroAssinaturaDadoCartaoPage */],
                __WEBPACK_IMPORTED_MODULE_28__pages_pag_seguro_assinatura_confirmacao_pag_seguro_assinatura_confirmacao__["a" /* PagSeguroAssinaturaConfirmacaoPage */],
                __WEBPACK_IMPORTED_MODULE_29__pages_pag_seguro_assinatura_sucesso_pag_seguro_assinatura_sucesso__["a" /* PagSeguroAssinaturaSucessoPage */],
                __WEBPACK_IMPORTED_MODULE_30__pages_lista_oportunidade_lista_oportunidade__["a" /* ListaOportunidadePage */],
                __WEBPACK_IMPORTED_MODULE_31__pages_lista_oportunidade_preco_lista_oportunidade_preco__["a" /* ListaOportunidadePrecoPage */],
                __WEBPACK_IMPORTED_MODULE_32__pages_lista_oportunidade_assinatura_lista_oportunidade_assinatura__["a" /* ListaOportunidadeAssinaturaPage */],
                __WEBPACK_IMPORTED_MODULE_33__pages_lista_oportunidade_generica_lista_oportunidade_generica__["a" /* ListaOportunidadeGenericaPage */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["c" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_6__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/pag-seguro-assinatura-confirmacao/pag-seguro-assinatura-confirmacao.module#PagSeguroAssinaturaConfirmacaoPageModule', name: 'PagSeguroAssinaturaConfirmacaoPage', segment: 'pag-seguro-assinatura-confirmacao', priority: 'low', defaultHistory: [] },
                        ...
                        { loadChildren: '../pages/pag-seguro-assinatura-sucesso/pag-seguro-assinatura-sucesso.module#PagSeguroAssinaturaSucessoPageModule', name: 'PagSeguroAssinaturaSucessoPage', segment: 'pag-seguro-assinatura-sucesso', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/signup/signup.module#SignupPageModule', name: 'SignupPage', segment: 'signup', priority: 'low', defaultHistory: [] }
                    ]
                }),
                __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_5__shared_sdk__["g" /* SDKBrowserModule */].forRoot(),
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__shared_sdk__["h" /* SDKModels */],
                __WEBPACK_IMPORTED_MODULE_5__shared_sdk__["e" /* LoopBackAuth */],
                __WEBPACK_IMPORTED_MODULE_5__shared_sdk__["d" /* InternalStorage */],
                ...
                __WEBPACK_IMPORTED_MODULE_23__shared_sdk_services_custom_NotificacaoApp__["a" /* NotificacaoAppApi */],
                __WEBPACK_IMPORTED_MODULE_24__shared_sdk_services_custom_UsuarioProduto__["a" /* UsuarioProdutoApi */],
                __WEBPACK_IMPORTED_MODULE_5__shared_sdk__["f" /* OportunidadeDiaApi */],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return OPORTUNIDADEDIA_LISTAOPORTUNIDADEPRECOPAGE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return OPORTUNIDADEDIA_LISTAOPORTUNIDADEPRECOASSINATURAPAGE; });
var OPORTUNIDADEDIA = [];
...
var OPORTUNIDADEDIA_LISTAOPORTUNIDADEPRECOASSINATURAPAGE = {};
//# sourceMappingURL=oportunidadeDia.js.map
...
var UsuarioProdutoApi = /** @class */ (function (_super) {
    ...
    UsuarioProdutoApi.prototype.RegistraAssinatura = function (chaveUsuario, pagSeguroId, customHeaders) {
        if (chaveUsuario === void 0) { chaveUsuario = {}; }
        if (pagSeguroId === void 0) { pagSeguroId = {}; }
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_8__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
        ...
        if (typeof chaveUsuario !== 'undefined' && chaveUsuario !== null)
            _urlParams.chaveUsuario = chaveUsuario;
        if (typeof pagSeguroId !== 'undefined' && pagSeguroId !== null)
            _urlParams.pagSeguroId = pagSeguroId;
        var result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
        return result;
    };
    /**
    ...
    UsuarioProdutoApi.prototype.PrimeiroAcesso = function (usuario, customHeaders) {
        var _method = "POST";
        var _url = __WEBPACK_IMPORTED_MODULE_8__app_const__["f" /* PathValidador */] + "/" + __WEBPACK_IMPORTED_MODULE_4__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
    ...
    UsuarioProdutoApi.prototype.ValidaLogin = function (login, senha, customHeaders) {
        ...
        if (typeof login !== 'undefined' && login !== null)
            _urlParams.login = login;
        if (typeof senha !== 'undefined' && senha !== null)
            _urlParams.senha = senha;
        var result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
        return result;
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_assinatura__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pag_seguro_assinatura_dado_cliente_pag_seguro_assinatura_dado_cliente__ = __webpack_require__(178);
...
var PagSeguroAssinaturaDadoIdentificacaoPage = /** @class */ (function () {
    function PagSeguroAssinaturaDadoIdentificacaoPage(navCtrl, navParams, fcmSrv) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.fcmSrv = fcmSrv;
        this.chavePagina = '3e7a39e09eec3244e6f75189eff5db97e3318bae';
        this.sender = {
            "name": "",
            "email": "",
            "hash": "",
    ...
    PagSeguroAssinaturaDadoIdentificacaoPage.prototype.preencher = function () {
    ...
    PagSeguroAssinaturaDadoIdentificacaoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-pag-seguro-assinatura-dado-identificacao',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-dado-identificacao/pag-seguro-assinatura-dado-identificacao.html"*/'<!--\n  Generated template for the PagSeguroAssinaturaDadoIdentificacaoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="titulo">\n    <ion-title >Identificação (1 de 4)</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-label padding>Assinatura: R$ 4,99 / mês</ion-label>\n  <form  (ngSubmit)="avancar()">\n    <ion-item>\n      <ion-label floating>Nome*</ion-label>\n      <ion-input [(ngModel)]="sender.name" name="name"></ion-input>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroNome">\n      <p class="erroMsg">{{erroNome}}</p>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Email*</ion-label>\n      <ion-input [(ngModel)]="sender.email" name="email"></ion-input>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroEmail">\n      <p class="erroMsg">{{erroEmail}}</p>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Telefone - DDD* (somente números)</ion-label>\n      <ion-input type="number" max="2" [(ngModel)]="sender.phone.areaCode" name="areaCode"></ion-input>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroTelDDD">\n      <p class="erroMsg">{{erroTelDDD}}</p>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Telefone - Número* (somente números)</ion-label>\n      <ion-input type="number" max="9" [(ngModel)]="sender.phone.number" name="number"></ion-input>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroTelNumero">\n      <p class="erroMsg">{{erroTelNumero}}</p>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>CPF* (somente números)</ion-label>\n      <ion-input type="number" max="11" [(ngModel)]="sender.documents[0].value" name="value"></ion-input>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroCpf">\n      <p class="erroMsg">{{erroCpf}}</p>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Data Nascimento*</ion-label>\n      <ion-datetime pickerFormat="DD/MM/YYYY" displayFormat="DD/MM/YYYY" [(ngModel)]="dataNascimento" name="dataNascimento"></ion-datetime>\n    </ion-item>\n    <ion-item no-lines *ngIf="erroNascimento">\n      <p class="erroMsg">{{erroNascimento}}</p>\n    </ion-item>\n    \n    <button ion-button type="submit" block>Avançar</button>\n  </form>\n</ion-content>\n\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/pag-seguro-assinatura-dado-identificacao/pag-seguro-assinatura-dado-identificacao.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_service__ = __webpack_require__(32);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__real_time__ = __webpack_require__(340);
/* unused harmony namespace reexport */
/* tslint:disable */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_operators__ = __webpack_require__(51);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UsuarioProduto; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__OportunidadeDia__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Usuario__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Acao__ = __webpack_require__(344);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_2__Acao__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Container__ = __webpack_require__(345);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__SDKModels__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__logger_service__ = __webpack_require__(346);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_sdk__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__componente_base__ = __webpack_require__(62);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var LoginPageBase = /** @class */ (function (_super) {
    ...
    function LoginPageBase(navCtrl, navParams, formBuilder, srv, srvAcao, storage, pagSeguro, fcmSrv) {
        var _this = _super.call(this) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.formBuilder = formBuilder;
        ...
        _this.pagSeguro = pagSeguro;
        _this.fcmSrv = fcmSrv;
        _this.chavePagina = '079053c61df3fa29a8c281c38a8a06d0526499f5';
    ...
    LoginPageBase.prototype.ionViewDidLoad = function () {
        ...
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_1__app_const__["g" /* VERSAO_APP_ID */]);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_sdk_index__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__componente_base__ = __webpack_require__(62);
...
var SignupPageBase = /** @class */ (function (_super) {
    ...
    function SignupPageBase(navCtrl, formBuilder, storage, srv, fcmSrv) {
        var _this = _super.call(this) || this;
        _this.navCtrl = navCtrl;
        _this.formBuilder = formBuilder;
        _this.storage = storage;
        _this.srv = srv;
        _this.fcmSrv = fcmSrv;
        _this.msgSenha = __WEBPACK_IMPORTED_MODULE_3__app_const__["b" /* MSG_CADASTRO_TAMANHO_SENHA */];
        _this.msgEmail = __WEBPACK_IMPORTED_MODULE_3__app_const__["a" /* MSG_CADASTRO_EMAIL */];
        _this.chavePagina = 'c2b925b0dd233741e199e83a93afc1ad46047828';
    ...
    SignupPageBase.prototype.ionViewDidLoad = function () {
        //console.log('ionViewDidLoad LoginPage');
        this.fcmSrv.registraVisitaPagina(this.chavePagina, __WEBPACK_IMPORTED_MODULE_3__app_const__["g" /* VERSAO_APP_ID */]);
    };
    ...
    SignupPageBase.prototype.processaSubmit = function () {
        var _this = this;
        this.usuario = new __WEBPACK_IMPORTED_MODULE_1__shared_sdk_index__["j" /* UsuarioProduto */]();
        ...
        if (senha1 != senha2) {
            ...
            this.storage.get("chave").then(function (chaveUsuario) {
                _this.usuario.chave = chaveUsuario;
                //alert("usuario:" + JSON.stringify(this.usuario));
                _this.srv.PrimeiroAcesso(_this.usuario)
                    .subscribe(function (result) {
                    //this.storage.set('user', result);
                    console.log('SignUp: ', result);
                    _this.navCtrl.push(_this.getPaginaInicial());
                }, function (error) {
...
}(__WEBPACK_IMPORTED_MODULE_2__componente_base__["a" /* ComponenteBase */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__const__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_observable_timer__ = __webpack_require__(144);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            _this.fcmSrv.executaValidacao(__WEBPACK_IMPORTED_MODULE_6__const__["g" /* VERSAO_APP_ID */]);
            _this.statusBar.styleDefault();
            _this.splashScreen.hide();
            Object(__WEBPACK_IMPORTED_MODULE_7_rxjs_observable_timer__["timer"])(3000).subscribe(function () { return _this.showSplash = false; });
        });
    };
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/app/app.html"*/'<div *ngIf="showSplash" class="splash">\n  <div class="spinner"></div>\n</div>\n\n\n<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/app/app.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */],
            __WEBPACK_IMPORTED_MODULE_5__servico_acessa_fcm_service__["a" /* AcessaFcmService */]])
    ], MyApp);
    return MyApp;
}());
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-home',template:/*ion-inline-start:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3>Ionic Menu Starter</h3>\n\n  <p>\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.\n  </p>\n\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n</ion-content>\n'/*ion-inline-end:"/home/usuario/aplicacoes/ProdutosNode/cosmetic/ionic3_back/src/pages/home/home.html"*/
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Cartao; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_base_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lb_config__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_auth_service__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_error_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__sockets_socket_connections__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7____ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_const__ = __webpack_require__(17);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var PagSeguroApi = /** @class */ (function (_super) {
    ...
    PagSeguroApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = __WEBPACK_IMPORTED_MODULE_8__app_const__["e" /* PathPagSeguro */] + "/" + __WEBPACK_IMPORTED_MODULE_3__lb_config__["a" /* LoopBackConfig */].getApiVersion() +
            "/PagSeguros";
        var _routeParams = {};
        var _postBody = {
            data: data
